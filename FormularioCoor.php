                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col s6 m6 l6">
                                                        ...
                                                        <table class="responsive-table">
                                                            ...
                                                            <tr>
                                                                <td class="celdasInfo"><input type="text" name="asignatura" value="<?php echo $_SESSION['asignatura'] ?>"></td>
                                                            </tr>
                                                            <tr>
                                                                <th class="celdasTitulo">Docente</th>
                                                            </tr>
                                                            <tr>
                                                                <td class="celdasInfo"><input type="text" name="docente" value="<?php echo $_SESSION['docente'] ?>" readonly></td>
                                                            </tr>
                                                        </table>
