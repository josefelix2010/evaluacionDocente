...
if($tipo==1){
	...
	$pdf->Cell(1);
	$pdf->Cell(3, 0.6, '#', 1, 0, "C", 1);
	$pdf->Cell(12, 0.6, 'Ítem', 1, 0, "C", 1);
	$pdf->Cell(3, 0.6, 'Respuesta', 1, 0, "C", 1);
	...
	while($valores = mysqli_fetch_array($query)){
		...
		$pdf->Cell(1);
		$pdf->Cell(3, 0.6, $count, 1, 0, "C", 1);
		$pdf->Cell(12, 0.6, $topico, 1, 0, "C", 1);
		$pdf->Cell(3, 0.6, $respuesta, 1, 0, "C", 1);
		$pdf->Ln();
	...
	$pdf->SetFont('Times', 'B', 12);
	$pdf->Cell(1);
	$pdf->Cell(8, 0.6, 'Docente', 1, 0, "C", 1);
	$pdf->Cell(1.2);
	$pdf->Cell(3, 0.6, utf8_decode('Evaluación'), 1, 0, "C", 1);
	$pdf->Cell(1.2);
	$pdf->Cell(4, 0.6, utf8_decode('Escalas de evaluación'), 1, 0, "C", 1);
	...
	$pdf->Cell(1);
	$pdf->Cell(8, 3, $comentario, 1, 0, "C", 1);
	$pdf->Cell(1.2);
	$pdf->Cell(1.5, 0.6, $evaluacionT, 1, 0, "C", 1);
	if($evaluacionT > 4.50 && $evaluacionT < 5.00){
		$pdf->Cell(1.5, 0.6, 'Muy bueno', 1, 0, "C", 1);
	}elseif($evaluacionT > 3.50 && $evaluacionT < 4.49){
		$pdf->Cell(1.5, 0.6, 'Bueno', 1, 0, "C", 1);
	}elseif($evaluacionT > 2.50 && $evaluacionT < 3.49){
		$pdf->Cell(1.5, 0.6, 'Aceptable', 1, 0, "C", 1);
	}elseif($evaluacionT > 1.50 && $evaluacionT < 2.49){
		$pdf->Cell(1.5, 0.6, 'Deficiente', 1, 0, "C", 1);
	}elseif($evaluacionT > 1.00 && $evaluacionT < 1.49){
		$pdf->Cell(1.5, 0.6, 'Muy deficiente', 1, 0, "C", 1);
	}
	$pdf->Cell(1.2);
	$pdf->Cell(2, 0.6, '4.50 -> 5', 1, 0, "C", 1);
	$pdf->Cell(2, 0.6, 'Muy bueno', 1, 0, "C", 1);

	$pdf->Ln();
	$pdf->Cell(1);
	$pdf->Cell(13.4);
	$pdf->Cell(2, 0.6, '3.50 -> 4.49', 1, 0, "C", 1);
	$pdf->Cell(2, 0.6, 'Bueno', 1, 0, "C", 1);

	$pdf->Ln();
	$pdf->Cell(1);
	$pdf->Cell(13.4);
	$pdf->Cell(2, 0.6, '2.50 -> 3.49', 1, 0, "C", 1);
	$pdf->Cell(2, 0.6, 'Aceptable', 1, 0, "C", 1);

	$pdf->Ln();
	$pdf->Cell(1);
	$pdf->Cell(13.4);
	$pdf->Cell(2, 0.6, '1.50 -> 2.49', 1, 0, "C", 1);
	$pdf->Cell(2, 0.6, 'Deficiente', 1, 0, "C", 1);

	$pdf->Ln();
	$pdf->Cell(1);
	$pdf->Cell(13.4);
	$pdf->Cell(2, 0.6, '1.00 -> 1.49', 1, 0, "C", 1);
	$pdf->Cell(2, 0.6, 'Muy Deficiente', 1, 0, "C", 1);
